...
namespace BRS.Scripts.UI {
    public class Menu : Component{
        ...
        public void LoadContent() {
            ...
            texturesButtons.Add("button", _textureButton);
            texturesButtons.Add("background", _textureButtonBackground);
            texturesButtons.Add("bigBackground", _textureButtonBigBackground);
            texturesButtons.Add("buttonCircle", _textureButtonCircle);
            texturesButtons.Add("title", _textureButtonTitle);
            texturesButtons.Add("arrowLeft", _textureArrowLeft);
            texturesButtons.Add("arrowRight", _textureArrowRight);
            texturesButtons.Add("forklift", _textureButtonForkLift);
            texturesButtons.Add("buttonAccept", _textureButtonAccept);


            functionsMenu = new Dictionary<string, EventHandler>();
            functionsMenu.Add("SwitchToMenu", MenuManager.Instance.SwitchToMenu);
            functionsMenu.Add("SetDefaultParametersGame", MenuManager.Instance.SetDefaultParametersGame);
            functionsMenu.Add("UpdateRoundDuration", MenuManager.Instance.UpdateRoundDuration);
            functionsMenu.Add("UpdateNoPlayers", MenuManager.Instance.UpdateNoPlayers);
            functionsMenu.Add("StartGameFunction", MenuManager.Instance.StartGameFunction);
            functionsMenu.Add("SwitchRankingDisplay", MenuManager.Instance.SwitchRankingDisplay);
            functionsMenu.Add("UpdateTemporaryNamePlayer", MenuManager.Instance.UpdateTemporaryNamePlayer);
            functionsMenu.Add("UpdatePlayersChangeTo", MenuManager.Instance.UpdatePlayersChangeTo);
            functionsMenu.Add("ChangeNamePlayer", MenuManager.Instance.ChangeNamePlayer);
            functionsMenu.Add("ChangeModelPlayer", MenuManager.Instance.ChangeModelPlayer);
            functionsMenu.Add("UpdatePlayersNameInfosToChange", MenuManager.Instance.UpdatePlayersNameInfosToChange);
            functionsMenu.Add("HighlightBorders", MenuManager.Instance.HighlightBorders);
            functionsMenu.Add("GoDown", MenuManager.Instance.GoDown);
            functionsMenu.Add("GoRight", MenuManager.Instance.GoRight);
            //functionsMenu.Add("ChangeModelNamePlayer", MenuManager.Instance.ChangeModelNamePlayer);
        }
        ...
        public void BuildPlayMenu() {
            ...
            string[] textButtons = { "2", "4", "2min", "3 min", "5 min" };
        ...
        public void CreatePanel(string pathName, string panelName, bool setPanelActive = false) {
            ...
            foreach (MenuStruct MS in panelObjects) {
                if (MS.menuType == MenuType.Button) {
                    if (MS.Name == "Alphabet") {
                        CreateAlphabetButtons(panelName);
                    }
                    else {
