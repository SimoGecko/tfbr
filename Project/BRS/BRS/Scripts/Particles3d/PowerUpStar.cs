...
namespace BRS.Scripts.Particles3D {
    ...
    /// </summary>
    class PowerUpStar : ParticleComponent {

        // --------------------- VARIABLES ---------------------

        private readonly ParticleType3D _particleType;

        public PowerUpStar(ParticleType3D particleType) {
        ...
        public override Tuple<Vector3, Vector3> GetNextPosition() {
            Vector3 pos = transform.position + RandomPointOnCircle(0.5f, MyRandom.Value - 0.5f);
