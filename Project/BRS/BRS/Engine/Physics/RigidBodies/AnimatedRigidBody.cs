...
namespace BRS.Engine.Physics.RigidBodies {
    ...
    class AnimatedRigidBody : RigidBodyComponent {
        ...
        public AnimatedRigidBody(float size = 1.0f, bool isActive = true, ShapeType shapeType = ShapeType.Box, bool pureCollider = false, GameObject synchedObject = null)
        ...
        /// <param name="pureCollider">True if it's only for collision -> simulation only adjusted by static-objects</param>
        /// <param name="synchedObject">The object which it's location and orientation is syned</param>
        public AnimatedRigidBody(Vector3 size, bool isActive = true, ShapeType shapeType = ShapeType.Box, bool pureCollider = false, GameObject synchedObject = null) {
            IsStatic = true;
            IsAnimated = true;
            IsActive = isActive;
            ShapeType = shapeType;
